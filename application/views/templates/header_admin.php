...
<head>
    ...
    <title>Dashboard| KPI PDAM</title>
        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="<?php echo base_url() ?>assets/img/notification/4.jpg" alt="" /></a>
					<h2>SISTEM <span class="min-dtn">KPI</span></h2>
				</div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Item Pertanyaan" href="<?php echo base_url() ?>Admin/ItemInputView"><span class="mini-sub-pro">Item Pertanyaan</span></a></li>
                                <li><a title="Group Pertanyaan" href="index-1.html"><span class="mini-sub-pro">Group Pertanyaan</span></a></li>
                                <li><a title="Section Pertanyaan" href="index-2.html"> <span class="mini-sub-pro">Section Pertanyaan</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
